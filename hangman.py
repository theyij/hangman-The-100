import random
from words import charactor_list


#get word from ref file
def get_word():
    word = random.choice(character_list)
    return word.upper()


#sequence for 1 game play
def play(word):
    ...
    guessed_words = []
    tries = 6
    print ("Let's play name in 'The 100' Hangman!")
    print (display_hangman(tries))
    print (word_completion)
    print ("\n")

    while not guessed and tries > 0:
        guess = input("Please guess a actor or charater name.").upper()
